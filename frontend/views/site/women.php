...
$shoe_women = Shoes::find()->where(['cat_id' => 2])->joinWith('images')->all();
...
<div class="container">
  ...
  <section class="text-center mb-4">
    ...
    <?php foreach ($shoe_women as $women) {?>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        ...
        <div class="card">
          ...
          <div class="view overlay">
            <img src="<?=Yii::$app->request->baseUrl . '/' . $women->images[0]->img_path?>" class="card-img-top" alt="">
            <a>
          ...
          <div class="card-body text-center">
            ...
            <a href="" class="grey-text">
              <h5><?=$women->shoe_name?></h5>

            </a>
            <h5>
              <strong>
                <a href="" class="dark-grey-text"><?=$women->description?>
