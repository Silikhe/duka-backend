...
<div class="cart-form">
    ...
    <div class="form-group">
        <?=Html::submitButton('Save to cart', ['class' => 'btn btn-success'])?>
    </div>
<!--
    <div class="form-group">
    <a href="<?=Url::to(['site/checkout'])?>">Proceed to checkout</a>
    </div> -->
...
<!-- <div class="container d-flex justify-content-center"> <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#exampleModal">GO TO LINK</button>
</div> -->
<!-- Modal -->
