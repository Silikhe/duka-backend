...
$shoe_men = Shoes::find()->where(['cat_id' => 1])->joinWith('images')->all();
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        ...
        <div class="card">
          ...
          <div class="view overlay">
            <img src="<?=Yii::$app->request->baseUrl . '/' . $men->images[0]->img_path?>" class="card-img-top" alt="">
            <a>
          ...
          <div class="card-body text-center">
            ...
            <h5>
              <strong>
                <a href="" class="dark-grey-text"><?=$men->description?>
